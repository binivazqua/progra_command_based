...
public final class Constants {
  ...
  public static class CommandSpeeds {
    ...
    public static final double ksquarebutton = 3;
    public static final double kcirclebutton = 4;
    public static final double ktrianglebutton = 1;
    public static final double kcrossbutton = 2;
